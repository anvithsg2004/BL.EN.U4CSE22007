    ...
    public CommandLineRunner initData(MongoTemplate mongoTemplate) {
        return args -> {
            ...
            StockPriceEntry[] entries = new StockPriceEntry[]{
                    ...
                    createEntry("NVDA", 998.27924, now.minus(20, ChronoUnit.MINUTES), now.plus(10, ChronoUnit.MINUTES)),
                    ...
                    createEntry("PYPL", 42.583908, now.minus(5, ChronoUnit.MINUTES), now.plus(10, ChronoUnit.MINUTES))
            };
